...
def process_dat_files(input_folder, output_folder, output_info_folder):
    ...
    vehCap = list(np.load('graph info/vehicleCapacity.npy', allow_pickle=True))
    # nuNod = list(np.load(p + 'dataset/graph info/numNodes.npy', allow_pickle=True))
    reqNod = list(np.load('graph info/requiredNodes.npy', allow_pickle=True))
    deNo = list(np.load('graph info/depotNodes.npy', allow_pickle=True))

    # Create the output folder if it doesn't exist
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)

    names = ['val1A.dat', 'val1B.dat', 'val1C.dat', 'val2A.dat', 'val2B.dat', 'val2C.dat', 'val3A.dat', 'val3B.dat', 
         'val3C.dat', 'val4A.dat', 'val4B.dat', 'val4C.dat', 'val4D.dat', 'val5A.dat', 'val5B.dat', 'val5C.dat', 'val5D.dat', 'val6A.dat', 'val6B.dat', 'val6C.dat', 'val7A.dat', 
         'val7B.dat', 'val7C.dat', 'val8A.dat', 'val8B.dat', 'val8C.dat', 'val9A.dat', 'val9B.dat', 'val9C.dat', 'val9D.dat', 'val10A.dat', 'val10B.dat', 'val10C.dat', 'val10D.dat']
    ...
    for _ , filename in enumerate(os.listdir(input_folder)):
        print(filename, ind)
        if filename.endswith('.dat') and ind < len(names) and filename == names[ind]:# and filename == "egl-s4-A.dat":
...
input_folder = "C:/Users/eashwar/Desktop/PhD Research/Multi-Trip-Algorithms/dataset/bccm/"  
output_folder = 'C:/Users/eashwar/Desktop/PhD Research/Multi-Trip-Algorithms/dataset/bccm/graph_files'  # Replace with the path where you want to save .net files
output_info_folder = 'C:/Users/eashwar/Desktop/PhD Research/Multi-Trip-Algorithms/dataset/bccm/graph info'
