...
def process_dat_files(input_folder, output_folder, output_info_folder):
    ...
    for ind, filename in enumerate(os.listdir(input_folder)):
...
input_folder = "C:/Users/eashw/Downloads/eglese/"  
output_folder = 'C:/Users/eashw/Downloads/eglese/graph_files'  # Replace with the path where you want to save .net files
output_info_folder = 'C:/Users/eashw/Downloads/eglese/graph info'
